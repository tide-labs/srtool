...
RUN echo $SHELL && \
    curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh -s -- --default-toolchain=1.68.0 -y && \
    . $CARGO_HOME/env && \
    rustup default 1.68.0-x86_64-unknown-linux-gnu && \
    rustup install nightly-2023-03-09 && \
    rustup target add wasm32-unknown-unknown --toolchain nightly-2023-03-09-x86_64-unknown-linux-gnu && \
